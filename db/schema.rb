...
ActiveRecord::Schema.define(version: 20140328010358) do
  ...
  add_index "match_histories", ["steam_id", "matches_id"], name: "index_match_histories_on_steam_id_and_matches_id", using: :btree
